...
class V2():
    def __init__(self):
        self.methods = {
            ...
            'mega_menu': ['breadcrums','get_mega_menu'],
            'order': ['place_order', 'get_list', 'get_summary', 'get_order_id', 'return_replace_item', 'get_razorpay_payment_url', 
                      'get_order_details','recently_bought', 'cancel_order'],
            'otp': ['send_otp', 'verify_otp','send_twilio_sms','send_email_otp','send_pinnacle_sms',
                    'login_with_mobile_otp',"send_otp_message","send_twilio_otp"],
