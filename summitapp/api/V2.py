...
class V2():
    def __init__(self):
        self.methods = {
            ...
            "product": ['get_list', 'product_search', 'get_details', 'get_cyu_categories', 'get_variants', 'get_recommendation', 'get_top_categories', "get_tagged_products", "check_availability", "get_categories",'get_default_currency', 'quick_order', 'get_variants_for_listing'],
