$(document).on('app_ready', function () {
    ...
    // chat_element.addClass('chat-icon');
    // chat_element.attr('id','chat-icon');
    // let i_comment = $(document.createElement('i'));
    // i_comment.addClass('fas fa-comment');
    // chat_element.append(i_comment);
    ...
    // Append all elements to the chat popup
    chatPopup.append(chatHeader).append(chatContent).append(chatFooter);
  
    // Append chat icon and chat popup to the main section
    $(".main-section").append(chatIcon).append(chatPopup);
  
    // Add click event for toggling the chat popup
    $("#chat-icon").on("click", function () {
      $("#chat-popup").toggle(); // Toggle between show and hide
    });
})
